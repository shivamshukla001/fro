  ...
  return (
    <div className='container'>
      ...
      <div className='row mt-5 mb-5 '>
        <h1 className='text-center mb-5'>We pioneered the discount broking model in India.
          <br /> Now, we are breaking ground with our technology.</h1>
      </div>

      <div className='row mt-5 p-5  '  style={{lineHeight:"1.8", fontSize:"1.2rem"}} >
        
        <div className='col p-5'>
          <p >
            We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company NextGen Trade, a combination of Zero and "Rodha", the Sanskrit word for barrier.</p>
